...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($nombre == "" || $apellido == "" || $mail == "" || $telefono == "") {
    ...
    } elseif ($region != "" && !in_array($region, $regiones)) {
        $mensaje_error = "La región seleccionada no es válida.";
    } else {
        ...
        if (mysqli_num_rows($resultado_verificar) > 0) {
            ...
            if (mysqli_stmt_execute($stmt_update)) {
                // Actualizar variables de sesión para que el menú muestre el nombre actualizado
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="region" class="form-select">
                                        ...
                                        <?php foreach ($regiones as $region_opcion) { ?>
                                            <option value="<?php echo htmlspecialchars($region_opcion); ?>" <?php if ($usuario["region"] == $region_opcion) echo "selected"; ?>>
                                                <?php echo htmlspecialchars($region_opcion); ?>
                                            </option>
                                        <?php } ?>
                                    </select>
                                </div>
