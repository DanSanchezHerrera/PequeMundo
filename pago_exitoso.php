...
<html lang="es">
    <head>
        ...
        <title>Pago exitoso - PequeMundo</title>
        <!-- Bootstrap CSS -->
            ...
            <section class="row justify-content-center">
                <div class="col-lg-7">
                    <article class="bg-white rounded shadow-sm p-5 text-center">
                        <!-- Imagen principal -->
                        <img src="img/pago_exitoso.png" alt="Pago exitoso" class="img-fluid mb-4" style="max-width: 180px;">
                        <!-- Mensaje principal -->
                        <h2 class="mb-3">¡Pago exitoso!</h2>
                        <p class="text-muted mb-4">Tu pago fue recibido correctamente. El pedido quedó registrado y pronto comenzará su preparación.</p>
                        <div class="alert alert-success">
                            <i class="fa-solid fa-circle-check"></i>
                            Gracias por comprar en PequeMundo.
                        ...
                        <div class="d-flex flex-column flex-md-row justify-content-center gap-3 mt-4">
                            <a href="catalogo.php" class="btn btn-finalizar-compra">Seguir comprando</a>
